...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			$("#"+$.jgrid.jqID(pgid) )
			.append("<div id='"+pgcnt+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+lft+"' align='left'></td><td id='"+cent+"' align='center' style='white-space:pre;'></td><td id='"+rgt+"' align='right'><div id='export_excel' class='ui-pg-button ui-corner-all' style='float:left;margin:1px 0 0 100px'></div><div id='export_pdf' class='ui-pg-button ui-corner-all' style='float:left;margin:1px 0 0 5px'></div></td></tr></tbody></table></div>")
